            ...
            <div className="space-y-4">
                ...
                <div className="relative">
                  <Mail 
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors ${
                      formFocused === 'email' ? 'text-orange-400' : 'text-gray-500'
                    }`} 
                    size={18} 
                  />
                  <input
              ...
              <div>
                ...
                <div className="relative">
                  <Lock 
                    className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors ${
                      formFocused === 'password' ? 'text-orange-400' : 'text-gray-500'
                    }`} 
                    size={18} 
                  />
                  <input
            ...
            <div className="space-y-4">
              <div className="text-center">
                <div className="mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Continue with Google</h3>
          ...
          <div className="mt-6 pt-6 border-t border-gray-700">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">3 free AI-powered backlink suggestions</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="text-green-400" size={16} />
                <span className="text-gray-400 text-sm">Personalized outreach templates</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="text-green-400" size={16} />
                <span className="text-gray-400 text-sm">Real-time link building analytics</span>
              </div>
            </div>
          </div>
        </div>
