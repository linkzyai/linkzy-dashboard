...
CREATE TABLE IF NOT EXISTS public.placement_opportunities (
  ...
  keyword_overlap_score text[] null default '{}'::text[],
  ...
  niche_proximity_score text null,
  domain_authority_score text null,
  geographic_relevance_score text null,
  partner_quality_score text null,
  overall_match_score text null,
